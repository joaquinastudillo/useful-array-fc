const inventors = [
  ...
  const order = inventors.sort((actualInventor, nextInventor) => actualInventor.year > nextInventor.year ? 1 : -1 )
  ...
  const orderLived = inventors.sort((firstInventor, nextInventor) => (firstInventor.passed - firstInventor.year) > (nextInventor.passed - nextInventor.year) ? -1 : 1 )
...
//8. Reduce Exercise
//Sum the instances of each of these
